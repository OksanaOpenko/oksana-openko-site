                ...
                <li key={nanoid()}>
                  ...
                  <p>
                    ...
                    <span className="accent-phrase">
                      “Статеве виховання. Про що, як і коли говорити з дітьми
                      про це.”
                    </span>{' '}
                    , в якому півтори години чіткої, структурованої інформації
                    про найголовніше (відповіді на більше ніж 30 найактуальніших
